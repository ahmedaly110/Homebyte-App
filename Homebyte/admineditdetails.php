   ...
   <body class="home">
      ...
      <header>
         ...
         <div class="header_full_banne">
            ...
            <div class="wrapper">
    <form action="PHP/upload_details.php" method="post" enctype="multipart/form-data" class="login-form">
        <!-- Add class "login-form" -->
        <div class="form-group">
            <label for="product_id">ID:</label>
            <input type="text" name="product_id" class="form-control" placeholder="product ID">
        </div>
        <div class="form-group">
            <label for="image1">Select product image 1 file:</label>
            <input type="file" name="image1" class="form-control" placeholder="Select image file">
        </div>
        <div class="form-group">
            <label for="image2">Select product image 2 file:</label>
            <input type="file" name="image2" class="form-control" placeholder="Select image file">
        </div>
        <div class="form-group">
            <label for="image3">Select product image 3 file:</label>
            <input type="file" name="image3" class="form-control" placeholder="Select image file">
        </div>
        <div class="form-group">
            <label for="image4">Select product image 4 file:</label>
            <input type="file" name="image4" class="form-control" placeholder="Select image file">
        </div>
        ...
        <input type="submit" name="submit" class="login-btn" value="Upload">
    </form>
</div>
