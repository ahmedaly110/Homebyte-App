   ...
   <body class="home">
      ...
      <header>
         ...
         <div class="header_full_banne">
            ...
            <div class="wrapper">
    <form action="PHP/upload_products.php" method="post" enctype="multipart/form-data" class="login-form">
        <!-- Add class "login-form" -->
        <div class="form-group">
            <label for="image">Select product image file:</label>
            <input type="file" name="image" class="form-control" placeholder="Select image file">
        </div>
