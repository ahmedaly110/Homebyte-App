   ...
   <body class="home">
      ...
      <header>
               ...
               <div class="collapse navbar-collapse" id="navbarsExample05">
                  <ul class="navbar-nav mr-auto">
                     ...
                     <li class="nav-item active">
                        <a class="nav-link" href="admineditreviews.php">Reviews</a>
                     </li>
         ...
         <div class="header_full_banne">
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="orders.php">About</a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="messages.php">shop</a>
                                 </li>
                                 <li class="nav-item">
            ...
            <div class="wrapper">
        <form action="PHP/uploadrev.php" method="post" enctype="multipart/form-data" class="login-form"> <!-- Add class "login-form" -->
    ...
    <?php include 'PHP/display_reviews.php'; ?>
</div>
